...
export default function Home() {
  return (
    <>
      <Head>
        <title>GenAI Assistant | DevOps Academy</title>
      </Head>
      ...
      <div className="flex flex-col min-h-screen bg-gradient-to-r from-purple-900 via-black to-blue-900 text-white font-sans">
        ...
        <header className="flex items-center justify-between px-8 py-5 bg-[#0b0f19] shadow-md border-b border-gray-800">
          <h1 className="text-xl font-bold text-purple-300">DevOps Academy</h1>
          ...
          <div className="space-x-4">
            <a href="https://www.youtube.com/@vishalshamkaria" target="_blank" rel="noopener noreferrer">
              <img src="/yt.svg" alt="YouTube" className="h-5 inline" />
            </a>
            <a href="https://www.linkedin.com/in/vishalshamkaria/" target="_blank" rel="noopener noreferrer">
        ...
        <footer className="text-center text-sm text-gray-500 py-4 border-t border-gray-800">
          © 2025 GenAI Assistant · <span className="text-purple-400">DevOps Academy</span>
        </footer>
      </div>
    </>
  );
